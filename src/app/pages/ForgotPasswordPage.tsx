...
import { AlertCircle, CheckCircle2, Loader2, ChevronRight, ArrowLeft } from "lucide-react";
      ...
      <div className="w-full max-w-md relative z-10">
        <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-3xl p-8 shadow-2xl">
          ...
          <button
            ...
            className="w-full mt-6 flex items-center justify-center gap-1.5 text-xs text-slate-400 hover:text-slate-300 transition-colors"
          >
